...
public class Controller {
    ...
    public Controller(float screenWidth, float screenHeight){
        ...
        input_arrows.setPosition(screenWidth * 0.1f, screenHeight * 0.1f);
        input_jump.setPosition(screenWidth - input_jump.getWidth() * scale - screenWidth * 0.1f, screenHeight * 0.1f);
