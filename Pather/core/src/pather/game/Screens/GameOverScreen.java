...
//This is the screen that's shown whenever a player character dies, original version by Brent Aureli
...
public class GameOverScreen implements Screen {
    ...
    public void render(float delta) {
        if(Gdx.input.justTouched()){
            //TODO: Change this to reflect our game over screen functionality
